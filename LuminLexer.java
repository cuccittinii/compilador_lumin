...
public class LuminLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CLARUS", "FLUX", "VERITAS", "VERUM", "FALSUM", "SE", "SENAO", "ENQUANTO", 
			"ECO", "CAPTURA", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "SEMI", "ASSIGN", 
			"PLUS", "MINUS", "MUL", "DIV", "GT", "LT", "EQ", "NEQ", "NUM_INT", "NUM_REAL", 
			"ID", "STRING", "WS"
		};
	}
	...
	public LuminLexer(CharStream input) {
		super(input);
